<template>
  ...
  <div class="card card-custom gutter-b col-xxl-12">
    <div class="card-header">
      ...
      <div class="card-body">
        ...
        <b-form-group id="input-group-num" :label="$t('ACT.NUM')" label-for="input-num">
          <b-form-input
            id="input-num"
            v-model="form.num"
            required
        ...
        >
          <b-form-select id="input-title" v-model="form.title_id" class="mb-3">
            <option value="3">
              {{ $t('ACT.TITLE.FS') }}
            </option>
            <option value="4">
        ...
        <b-form-group
          ...
          label-for="input-com"
        >
          <b-form-select id="input-com" v-model="form.com_id" class="mb-3" disabled>
            <option value="1">
              {{ $t('ACT.COM.FS') }}
            </option>
          </b-form-select>
  ...
  <div class="card card-custom gutter-b col-xxl-12" v-if="hasItem">
    ...
    <div class="card-body">
      ...
      <p class="text-monospace mt-6" v-for="item in items" :key="item">{{ item }}</p>
    </div>
  </div>
</div>
</template>
