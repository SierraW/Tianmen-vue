		...
		<div class="row">
			<div class="col-xl-12">
        		...
        		<div
          			...
          			style="height: 220px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(/media/svg/patterns/taieri.svg)"
        			>
          			<!--begin::Body-->
